...
<body>
  ...
  <div id="page"> 
    <header >
      <h1 contenteditable="true">Iterative Generated Shadows using Sass</h1>
    </header>
    
    <div id="main" role="main">
      <nav>
        <ul>
          <li><a href="wtf">Generated Shadows</a> - simple version</li>
          <li><a href="omg">in circles</a> - using trig</li>
          <li><a href="omgwtf">and other patterns</a> - non-circular trig</li>
          <li><a href="lmao">and fractals</a> - crazy and stupid. </li>
        </ul>
      </nav>
      note: the text on all of these is 'contenteditable'. go to town and change up the text. 
    </div>
